...
export const ChessIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    {/* A simplified chess icon (e.g., a knight or king silhouette) might be more common */}
    {/* Using a generic game controller icon as a placeholder for better visuals if the original was problematic */}
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zM9.5 16.5l7-4.5-7-4.5v9zM8 18h2v-4h4v4h2V6h-2v3h-1V6H9v3H8V6H6v12h2z" stroke="none" />
     <path d="M11 9h2V6h-2v3zm0 5h2v-3h-2v3z" stroke="none"/>
  </svg>
);
...
export const OnlineIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  // Placeholder Globe icon, original had complex/potentially problematic path
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
...
export const TrashIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12.56 0c1.153 0 2.243.492 3.01.822m-3.01-.822c-.722.288-1.404.64-2.016 1.044M9.124 18.75c-1.161 0-2.135-.324-2.888-.873M14.876 18.75c1.161 0 2.135-.324 2.888-.873" />
  </svg>
);
